class SingleDimensionArray{
	...
	public static void printAllEvenandDivisibleBy11Array(int[] myArray){
		int i = 0;
		while(i < myArray.length){
			int value = myArray[i]%2;
			switch(value){
				case 0:
					int value2 = myArray[i]%11;
					switch(value2){
					case 0:
						System.out.print(myArray[i] + " ");
						break;
	...
	//method to print all elements divisible by 11 in array
	public static void printDivisibleByElevenArray(int[] myArray){
		int i = 0;
		while(i < myArray.length){
			int value = myArray[i]%11;
			switch(value){
				case 0:
				System.out.print(myArray[i] + " ");
				break;
